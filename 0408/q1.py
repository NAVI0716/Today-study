...
f=open("국제시장환율.csv","w",encoding='utf-8-sig',newline="")
writer=csv.writer(f)
...
print(f"{1}페이지를 추출중")
for i in data:
    data_in.append([i.text.strip(),i.next_sibling.next_sibling.text.strip(),i.next_sibling.next_sibling.next_sibling.next_sibling.text.strip(),i.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.text.strip(),i.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.next_sibling.text.strip().replace('\n',"").replace('\t',"")])
print(f"{1}페이지 종료")
